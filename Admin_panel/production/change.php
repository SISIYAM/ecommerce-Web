...
if(isset($_POST['edit_Btn'])){
  ...
  $image_querry = "SELECT * FROM admin WHERE id='$admin_id' ";
  ...
  foreach($image_querry_run as $fa_row){
   ...
   $q ="UPDATE admin SET username = '{$username}',email = '{$email}',image = '{$image_data}' WHERE id = {$admin_id}";
     $querry = mysqli_query($con,$q);
...
?>
            ...
            <div class="item form-group">
              <label class="col-form-label col-md-3 col-sm-3 label-align" for="mobile">Profile Picture<span
                  class="required">*</span>
              </label>
              <div class="col-md-6 col-sm-6 ">

                <a href="<?php echo $result['image']; ?>" target="_blank"><img src="<?php echo $result['image']; ?>"
                    height="80" width="80" alt=""></a>
                <br> <br> <input type="file" class="input" name="img" class="form-control"
            ...
            ?>
              ...
              <div class="item form-group">
                ...
                ?>" alt="..." height="180" width="180"
                      style="   box-shadow: 0px 0px 5px rgba(0, 0,0,0.5); border: 1px solid #ddd; border-radius:50%;">
                  </div>
                </div>
              </div> <br>
              <div class="item form-group">
