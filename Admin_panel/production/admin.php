    ...
    ?></b></h5>
          ...
          ?>
            ...
            <ul class="nav navbar-right panel_toolbox">
              <a href="add_admin.php" style="margin-right:30px;"> <input type="submit" value="Add New Admin"
                      ...
                      <tr>
                        ...
                        <td>
                          <div style="display:flex; justify-content:space-between;"><b
                              style="margin-right:20px;"><?php echo $res['username'] ?></b>
                            <p style="<?php echo $style ?>">
                              <?php echo $current_status ?></p>
                          </div>
                          <?php
   if($res['last_login']<$time){
