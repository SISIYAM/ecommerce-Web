...
if(isset($_POST['submit'])){
    ...
    if($username_count){
        ...
        if($pass_decode){
          ...
          <div class='wrapper'>
          <b>Dear $usersent</b> 
          <h4>We are sending you this email further to your successful login to SiMovieZone Admin area.</h4>
...
<h3>This email is intended to inform you about the security of your account.</h3>
          ...
          $mail = new PHPMailer(true);
              ...
              //Recipients
              $mail->setFrom(EMAIL,'support@SiMovieZone');     //Add a recipient
              ...
              $mail->Subject = 'Successful authorization-SiMovieZone';
              $mail->Body    = $msg;
  ...
  ?>
    ...
    ?></h4>
          ...
          <form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST">
            ...
            <div class="link forget-pass text-left" style="margin:20px 0;"><a
                style="font-weight:bold; font-size:15px; color:#455B92;" href="forgot-password.php">Forgot password?</a>
            </div>
