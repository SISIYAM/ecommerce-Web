...
while($product_show_query_result = mysqli_fetch_array($product_show_query_run))
{
    ?>
                ...
                <tr>
                  <td><a href="product_details.php?id=<?php echo $product_show_query_result['product_id'] ?>"> <img
                        src="Admin_panel/production/<?php echo $product_show_query_result['product_image']; ?>"
                        height=55 width=55 alt=""></a></td>
                  <td style=" width:40%;><a href="
                    product_details.php?id=<?php echo $product_show_query_result['product_id'] ?>"
                    style="color:black; font-size:15px;">
                    <?php echo $product_show_query_result['product_name']; ?></a></td>
                  <td>Quantity: <?php echo $product_show_query_result['quantity'] ?></td>
                  <td style="color:red; font-weight:600;"> &#2547;
                    <?php echo $product_show_query_result['quantity']*$product_show_query_result['product_price']; ?>
                  </td>
                  <td><a href="delete/cart_delete.php?c_id=<?php echo $product_show_query_result['c_id']; ?>" class=""
                      style="color:black; "><i class="fa fa-times"></i></a></td>
                </tr>
...
?>
            ...
            <div style="">
              <span>
                <p style="border-bottom: 1px solid grey; padding:5px 0; font-weight:bold; color:black;">Shipping Charge:
                  <strong style="color:red;">&#2547; <?php echo $s_charge ?></strong> </p>

                <p style="font-weight: bolder;color:black;">Total: <strong style="color:red;">&#2547;
                    <?php echo $sum + $s_charge ?></strong></p>
              </span>
            </div>
          </div>
...
while($product_show_query_result = mysqli_fetch_array($product_show_query_run))
{
    ?>
                ...
                <tr>
                  ...
                  <td>Quantity: </td>
                  <td style="color:red; font-weight:600;"> &#2547;
                    <?php echo $product_show_query_result['product_price']; ?></td>
                  <td><a href="delete/wishlist_delete.php?w_id=<?php echo $product_show_query_result['w_id']; ?>"
                      class="" style="color:black; "><i class="fa fa-times"></i></a></td>
...
while($dept= mysqli_fetch_array($querry))
{
 ...
 while($sub_cat_result = mysqli_fetch_array($sub_cat_show_query)){
    ?>
                    <li><a
                        href="shop.php?subCategory=<?= $sub_cat_result['s_id'];?>"><?= $sub_cat_result['s_name'];?></a>
                    </li>
                    <?php
 }
?>
          ...
          <div class="category" style=" margin:20px 10px; box-shadow: 0 5px 100px rgba(0, 0, 0, 0.1);">
            <div class="col-lg-3" style="padding:10px;">
              <div class="categories__item set-bg" data-setbg="Admin_panel/production/<?php echo $res['cat_image'] ?>">
                <h5><a href="shop.php?category=<?php echo $res['cat_id']; ?>"><?php echo $res['cat_name'] ?></a></h5>
              </div>
            </div>
          </div>
          ...
          <div class="featured__item" style="">
            <div style="" class="featured__item__pic set-bg"
              ...
              <ul class="featured__item__pic__hover">
                <div> <a href="product_details.php?id=<?php echo $product_result['id']; ?>" style=""><button
                      class="btn btn-secondary">View</button></a> </div> <br><br>
                <li>
                  <!---- Wishlist--->
                  <form action="includes/code.php" method="post">
                    <input type="hidden" name="user_id" value="<?php echo $user_id ?>">
                    <input type="hidden" name="product_id" value="<?php echo $product_result['id'] ?>">
                    <input type="hidden" name="product_name" value="<?php echo $product_result['name'] ?>">
                    <input type="hidden" name="product_image" value="<?php echo $product_result['image'] ?>">
                    <input type="hidden" name="product_price" value="<?php echo $product_result['price'] ?>">
                ...
                <li>
                  ...
                  <form action="includes/code.php" method="post">
                    ...
                    <input type="hidden" name="product_charge" value="<?php echo $product_result['shipping_charge'] ?>">
            ...
            <div class="featured__item__text">
              <h6 style="font-weight:bold;"><a
                  href="product_details.php?id=<?php echo $product_result['id']; ?>"><?php echo substr($productName,0,60) ?>...</a>
              </h6>
...
?>
      ...
      <a href="shop.php?all"><button style="width:100%" class="btn btn-info"> See All</button></a>
    </div>
  </section>
